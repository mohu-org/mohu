...
//! | Macro | Purpose |
//! |-------|---------|
//! | [`dtype_of!`](crate::dtype_of) | `DType` constant for a Rust type literal |
//! | [`dispatch_dtype!`](crate::dispatch_dtype) | runtime DType → monomorphised call |
//! | [`dispatch_numeric!`](crate::dispatch_numeric) | same, excluding `Bool` |
//! | [`dispatch_integer!`](crate::dispatch_integer) | integers only |
//! | [`dispatch_float!`](crate::dispatch_float) | floats only (F16/BF16/F32/F64) |
//! | [`dispatch_real!`](crate::dispatch_real) | integers + real floats (no complex, no bool) |
//! | [`dispatch_signed!`](crate::dispatch_signed) | signed integers + floats |
//! | [`for_each_dtype!`](crate::for_each_dtype) | invoke a macro for every dtype (codegen helper) |
//! | [`assert_dtype!`](crate::assert_dtype) | assert a DType at runtime or return an error |
