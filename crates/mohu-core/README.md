...
- It is useful for the projects that requires different operations to perform such as error handling, data types, buffer and arrays.
- Individual crates are used when the project requires single component instead of many.
