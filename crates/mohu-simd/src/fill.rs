...
macro_rules! impl_fill {
    ($fn_name:ident, $fn_avx2:ident, $fn_scalar:ident, $ty:ty, $chunk_size:expr, $avx2_set:ident, $avx2_store:ident, $vec_ty:ident) => {
        ...
        // SAFETY: Caller must ensure `dst` is valid for `len` elements and properly aligned.
        #[inline(always)]
        ...
        unsafe fn $fn_avx2(mut dst: *mut $ty, mut len: usize, val: $ty) {
            ...
            let vec_val = unsafe { $avx2_set(val) };
...
impl_fill!(fill_f32, fill_f32_avx2, fill_f32_scalar, f32, 8, _mm256_set1_ps, _mm256_storeu_ps, __m256);
impl_fill!(fill_f64, fill_f64_avx2, fill_f64_scalar, f64, 4, _mm256_set1_pd, _mm256_storeu_pd, __m256d);
impl_fill!(fill_i32, fill_i32_avx2, fill_i32_scalar, i32, 8, _mm256_set1_epi32, _mm256_storeu_si256, __m256i);
impl_fill!(fill_i64, fill_i64_avx2, fill_i64_scalar, i64, 4, _mm256_set1_epi64x, _mm256_storeu_si256, __m256i);
